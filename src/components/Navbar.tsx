...
export function Navbar({
    ...
    const navItems = [
        ...
        { label: "Schedule", page: "screenings" as const },
                    ...
                    {navItems.map((item) => {
                        ...
                        return (
                            <motion.button
                                ...
                                whileHover={{ scale: 1.05 }}
                                whileTap={{ scale: 0.98 }}
                                className={`relative transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-slate-400/50 rounded px-2 py-1 ${isActive
                                        ? colors.active
